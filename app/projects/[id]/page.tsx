...
const projects = [
  ...
  },
  {
    ...
    impact: 'Live showcase of AI productization: an AI Code Mentor integrated directly into the site using AI SDK 6.0 with streaming chat, floating widget, and tool-call-free architecture. Demonstrates frontend engineering, LLM integration, and modern animation architecture.',
